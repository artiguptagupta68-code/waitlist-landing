...
def detect_interest(text):
    ...
    if "data" in text or "ml" in text or "ai" in text:
        return "Data Science"
    elif "dev" in text or "software" in text or "coding" in text:
        return "Software Development"
    elif "market" in text or "growth" in text:
        return "Marketing"
...
content_map = {
    ...
    "Marketing": {
        ...
        "desc": "Campaigns and growth strategies.",
    ...
    "General": {
        ...
        "desc": "Explore opportunities across domains.",
